...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println(" r " + (square_result == square_expected));
        System.out.println(" r " + (triangle_result == triangle_expected));
        System.out.println(" r " + (pentagon_result == pentagon_expected));
    }
}
